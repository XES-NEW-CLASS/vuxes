import Vue from 'vue'
import Elements from '../../packages/index.js'
 ...
 * @param  {Object}  propsData 非必填项      - props 数据
 * @param  {Boolean=false} mounted  - 是否添加到 DOM 上
 * @return {Object} vm
 */
export const createTestVue = function (Compo, propsData = {}, mounted = false) {
...
/**
 * 寻找某个元素
 * @param wrapper vue-test-util渲染后的元素
 * @param selector 筛选条件
 * @returns {*}
 */
